...
class RegistrarUsuarioUseCase:
    ...
    async def execute(self, dto: RegistrarUsuarioDTO) -> UsuarioCreadoDTO:
        ...
        # 2. Hash password
        hashed_password = self.password_hasher.hash(dto.contrasena)
        ...
        await self.email_service.send_verification_email(created_user.email, verification_token_value)

        # 6. Return UsuarioCreadoDTO
