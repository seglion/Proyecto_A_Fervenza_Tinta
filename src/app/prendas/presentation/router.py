...
from src.app.prendas.application.use_cases.crear_prenda_use_case import CrearPrendaUseCase # Añadido
from src.app.prendas.application.dtos import ListaPrendasDTO, PrendaDetalleDTO, CrearPrendaDTO, PrendaCreadaDTO # Modificado
