...
@pytest.mark.asyncio
async def test_confirmar_pago_pedido(mock_pedido_repository, mock_temporada_pedido_repository, mock_payment_gateway, mock_pedido_policy, user_registrado, temporada_activa, pedido_borrador_con_linea):
    # Arrange
    ...
    mock_payment_gateway.crear_sesion_pago.return_value = ("https://checkout.stripe.com/pay/cs_test_123", "cs_test_123")

    use_case = ConfirmarPagoPedidoUseCase(mock_pedido_repository, mock_temporada_pedido_repository, mock_payment_gateway, mock_pedido_policy)
    ...
    assert saved_pedido.estado == EstadoPedido.PENDIENTEPAGO
    assert saved_pedido.id_transaccion_externa == "cs_test_123"