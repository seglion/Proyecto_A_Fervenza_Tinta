...
def upgrade() -> None:
    ...
    op.create_table('temporadapedidos',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('nombre_temporada', sa.String(length=100), nullable=False),
    sa.Column('fecha_inicio', sa.Date(), nullable=False),
    sa.Column('fecha_fin', sa.Date(), nullable=False),
    ...
    sa.Column('usuario_id', sa.UUID(), nullable=False),
    sa.Column('temporada_id', sa.Integer(), nullable=False),
    sa.Column('estado', sa.Enum('BORRADOR', 'PENDIENTEPAGO', 'COMPLETADO', 'ENCARGADO', 'CANCELADO', name='estado_pedido_enum'), nullable=False),
    sa.Column('total_calculado', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('metodo_pago', sa.Enum('STRIPE', 'ENCARGO', 'MANUAL', name='metodo_pago_pedido_enum'), nullable=True),
    sa.Column('id_transaccion_externa', sa.String(length=255), nullable=True),
    sa.Column('fecha_creacion', sa.DateTime(timezone=True), nullable=False),
    sa.Column('fecha_finalizacion', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['temporada_id'], ['temporadapedidos.id'], ),
    sa.ForeignKeyConstraint(['usuario_id'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_transaccion_externa')
    )
    op.create_table('lineadepedidos',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('pedido_id', sa.UUID(), nullable=False),
    sa.Column('variante_prenda_id', sa.UUID(), nullable=False),
    sa.Column('cantidad', sa.Integer(), nullable=False),
    sa.Column('precio_unitario_conxelado', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('desc_variante_conxelada', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['pedido_id'], ['pedidos.id'], ),
    sa.ForeignKeyConstraint(['variante_prenda_id'], ['varianteprendas.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('lineadepedidos')
    op.drop_table('pedidos')
    op.drop_table('temporadapedidos')
