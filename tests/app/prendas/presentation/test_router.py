...
from src.app.prendas.presentation.router import router as prendas_router, get_listar_prendas_use_case, get_ver_detalle_prenda_use_case
from src.app.prendas.application.dtos import ListaPrendasDTO, PrendaDetalleDTO, PrendaDTO, VariantePrendaDTO, TallaPrenda, GeneroPrenda
...
async def test_ver_detalle_prenda_not_found(app_client, active_user, mock_ver_detalle_prenda_use_case):
    ...
    app_client.app.dependency_overrides[get_current_user] = lambda: active_user
    app_client.app.dependency_overrides[get_ver_detalle_prenda_use_case] = lambda: mock_ver_detalle_prenda_use_case
    mock_ver_detalle_prenda_use_case.execute.side_effect = PrendaNotFoundError(f"Prenda con id {prenda_id} no encontrada")
